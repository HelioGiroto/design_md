...
- **Nome:** Exaggerated Minimalism
- **Tipo:** Ultra-Clean, Spacious, Bold-Type, Restrained
...
- **Primárias:** #000000 (Black), #FFFFFF (White), single vibrant accent only
- **Secundárias:** Minimal - single accent color, no secondary colors, extreme restraint
...
Exaggerated Minimalism — Design general com bold minimalism, oversized typography, high contrast. Template e prompt pronto para IA. Estilo Exaggerated Minimalism representa uma tendência moderna em design UI/UX web com foco em general.
...
Estilo Exaggerated Minimalism representa uma tendência moderna em design UI/UX web com foco em general.
