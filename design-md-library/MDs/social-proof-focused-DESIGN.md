# Design System: Social Proof-Focused

## 1. Definição do Estilo

- **Nome:** Social Proof-Focused
- **Tipo:** Landing Page
...
- **Primárias:** Primary brand, trust colors (blue), success/growth colors (green), neutral backgrounds
- **Secundárias:** Testimonial highlight colors, logo grid backgrounds (light grey), badge/achievement colors
...
Social Proof-Focused — Design landing page com testimonials prominent, client logos displayed, case studies sections. Template e prompt pronto para IA. Estilo Social Proof-Focused representa uma tendência moderna em design UI/UX web com foco em landing page.
...
Estilo Social Proof-Focused representa uma tendência moderna em design UI/UX web com foco em landing page.
