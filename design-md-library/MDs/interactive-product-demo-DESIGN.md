# Design System: Interactive Product Demo

## 1. Definição do Estilo

- **Nome:** Interactive Product Demo
- **Tipo:** Landing Page
...
- **Primárias:** Primary brand, interface colors matching product, demo highlight colors for interactive elements
- **Secundárias:** Product UI colors, tutorial step colors (numbered progression), hover state indicators
...
Interactive Product Demo — Design landing page com embedded product mockup/video, interactive elements, product walkthrough. Template e prompt pronto para IA. Estilo Interactive Product Demo representa uma tendência moderna em design UI/UX web com foco em landing page.
...
Estilo Interactive Product Demo representa uma tendência moderna em design UI/UX web com foco em landing page.
