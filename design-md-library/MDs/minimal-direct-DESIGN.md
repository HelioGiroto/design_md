...
- **Primárias:** Monochromatic primary, white background, single accent color for CTA, black/dark grey text
- **Secundárias:** Minimal secondary colors, reserved for critical CTAs only, neutral supporting elements
...
Minimal & Direct — Design landing page com minimal text, white space heavy, single column layout. Template e prompt pronto para IA. Estilo Minimal & Direct representa uma tendência moderna em design UI/UX web com foco em landing page.
...
Estilo Minimal & Direct representa uma tendência moderna em design UI/UX web com foco em landing page.
