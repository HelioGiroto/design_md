...
- **Primárias:** Brand colors, professional palette (blue/grey/white), accent for KPIs, red for alerts/concerns
- **Secundárias:** KPI highlight colors: positive (green), negative (red), neutral (grey), trend arrow colors
...
Executive Dashboard — Design bi/analytics com high-level kpis, large key metrics, minimal detail. Template e prompt pronto para IA. Estilo Executive Dashboard representa uma tendência moderna em design UI/UX web com foco em bi/analytics.
...
Estilo Executive Dashboard representa uma tendência moderna em design UI/UX web com foco em bi/analytics.
