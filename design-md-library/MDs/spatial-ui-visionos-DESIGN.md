# Design System: Spatial UI (VisionOS)

## 1. Definição do Estilo

- **Nome:** Spatial UI (VisionOS)
- **Tipo:** Spatial, Translucent, Immersive, Futuristic
...
- **Primárias:** Frosted Glass #FFFFFF (15-30% opacity), System White
- **Secundárias:** Vibrant system colors for active states, deep shadows for depth
...
Spatial UI (VisionOS) — Design general com glass, depth, immersion. Template e prompt pronto para IA. Estilo Spatial UI (VisionOS) representa uma tendência moderna em design UI/UX web com foco em general.
...
Estilo Spatial UI (VisionOS) representa uma tendência moderna em design UI/UX web com foco em general.
