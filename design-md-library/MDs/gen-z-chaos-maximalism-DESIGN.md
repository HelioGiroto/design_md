# Design System: Gen Z Chaos / Maximalism

## 1. Definição do Estilo

- **Nome:** Gen Z Chaos / Maximalism
- **Tipo:** Chaotic, Maximalist, Colorful, Expressive
...
- **Primárias:** Clashing Brights: #FF00FF, #00FF00, #FFFF00, #0000FF
- **Secundárias:** Gradients, rainbow, glitch, noise, heavily saturated mix
...
Gen Z Chaos / Maximalism — Design general com chaos, clutter, stickers. Template e prompt pronto para IA. Estilo Gen Z Chaos / Maximalism representa uma tendência moderna em design UI/UX web com foco em general.
...
- **#FF00FF** (#FF00FF) — Primary surface or dominant color
- **#00FF00** (#00FF00) — Secondary surface or text color
- **#FFFF00** (#FFFF00) — Supporting palette color
- **#0000FF** (#0000FF) — Supporting palette color
...
Estilo Gen Z Chaos / Maximalism representa uma tendência moderna em design UI/UX web com foco em general.
