# Design System: Feature-Rich Showcase

## 1. Definição do Estilo

- **Nome:** Feature-Rich Showcase
- **Tipo:** Landing Page
...
- **Primárias:** Primary brand, bright secondary colors for feature cards, contrasting accent for CTAs
- **Secundárias:** Supporting colors for: benefits (green), problems (red/orange), features (blue/purple), social proof (neutral)
...
Feature-Rich Showcase — Design landing page com multiple feature sections, grid layout, benefit cards. Template e prompt pronto para IA. Estilo Feature-Rich Showcase representa uma tendência moderna em design UI/UX web com foco em landing page.
...
Estilo Feature-Rich Showcase representa uma tendência moderna em design UI/UX web com foco em landing page.
