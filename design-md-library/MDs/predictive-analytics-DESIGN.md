# Design System: Predictive Analytics

## 1. Definição do Estilo

- **Nome:** Predictive Analytics
- **Tipo:** BI/Analytics
...
- **Primárias:** Forecast line color (distinct from actual), confidence interval shading, anomaly highlight (red alert), trend colors
- **Secundárias:** High confidence (dark color), low confidence (light color), anomaly colors (red/orange), normal trend (green/blue)
...
Predictive Analytics — Design bi/analytics com forecast lines, confidence intervals, trend projections. Template e prompt pronto para IA. Estilo Predictive Analytics representa uma tendência moderna em design UI/UX web com foco em bi/analytics.
...
Estilo Predictive Analytics representa uma tendência moderna em design UI/UX web com foco em bi/analytics.
