# Design System: AI-Native UI

## 1. Definição do Estilo

- **Nome:** AI-Native UI
- **Tipo:** Intelligent, Adaptive, Conversational, Modern
...
- **Primárias:** Neutral + single accent, #6366F1 (AI Purple), #10B981 (Success), #F5F5F5 (Background)
- **Secundárias:** Status indicators, streaming highlights, context card colors, subtle accent variations
...
AI-Native UI — Design general com chatbot, conversational, voice. Template e prompt pronto para IA. Estilo AI-Native UI representa uma tendência moderna em design UI/UX web com foco em general.
...
- **#6366F1** (#6366F1) — Primary surface or dominant color
- **#10B981** (#10B981) — Secondary surface or text color
...
Estilo AI-Native UI representa uma tendência moderna em design UI/UX web com foco em general.
